	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (code != "") {
			...
			TimerTask task = new TimerTask() {
				...
				@Override
				public void run() {
					Intent goDashboard = new Intent(getApplicationContext(), Home.class);

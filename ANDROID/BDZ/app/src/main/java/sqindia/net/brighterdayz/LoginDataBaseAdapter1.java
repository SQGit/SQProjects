...
/**
 * Created by sagayam on 18-04-2016.
 */
...
public class LoginDataBaseAdapter1{
    ...
    public void insertEntry(String fname,String userName,String password,String confirmPassword,String emails,String phoneNo)
    {
        ...
        newValues.put("REPASSWORD",confirmPassword);
        newValues.put("EMAIL",emails);

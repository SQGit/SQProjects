...
String s1="";
    ...
    public static String makeRequest1(String url, String json,String AuthToken) {
        ...
        try {
            HttpPost httpPost = new HttpPost(url);
            httpPost.setEntity(new StringEntity(json));
            httpPost.setHeader("session_token",AuthToken);
            httpPost.setHeader("Accept", "application/json");
    ...
    public static String makeRequest(String url, String json,String AuthToken) {
        Log.v(TAG, "URLConfig-->" + url);
        Log.v(TAG, "input-->" + json);
    ...
    public static String makeRequest_transction(String url, String json,String AuthToken,String transctionid) {
        Log.d("tag", "URLConfig-->" + url);
        Log.d("tag", "input-->" + json);
        ...
        try {
            ...
            httpPost.setEntity(new StringEntity(json));
            httpPost.setHeader("session_token", AuthToken);
            httpPost.setHeader("transaction_id",transctionid);
            httpPost.setHeader("Accept", "application/json");
            httpPost.setHeader("Content-Type", "application/json");
            HttpResponse httpResponse = new DefaultHttpClient().execute(httpPost);

...
public class Profileupdate extends AppCompatActivity implements CalendarDatePickerDialogFragment.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Typeface tf1 = Typeface.createFromAsset(getAssets(), "fonts/Montserrat-Regular.otf");
...
//>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> Editext intiate>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
        ...
        dateofbith.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               /* CalendarDatePickerDialogFragment cdp = new CalendarDatePickerDialogFragment().setOnDateSetListener(Profileupdate.this);

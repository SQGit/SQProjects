...
public class ViewDetailActivity extends Activity {
    Intent i;
    String str_stockid,str_description,str_mileage,str_transmission,str_keys,str_head,str_vehicle_class,str_engine,str_startcode,str_vin,str_location,str_exterior,str_interior,str_desc,str_door,str_manufacture,str_condition;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        {
            mileage_tv.setText(str_mileage+"K Miles");
        }

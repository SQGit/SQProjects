        ...
        protected void onPostExecute(String s) {
            ...
            pDialog.dismiss();
                ...
                try {
                  ...
                  //  {"status":"SUCCESS","message":"Hospital registered Successfully","data":{"hospitalId":63,"hospitalAdminId":112}}
                    if (status.equals("SUCCESS")) {
                        String msg = jo.getString("message");
                        JSONObject data = jo.getJSONObject("data");
                        String hospitalId=data.getString("hospitalId");
                        Log.d("tag", "<-----hospitalIdhospitalIdhospitalId----->" + hospitalId);

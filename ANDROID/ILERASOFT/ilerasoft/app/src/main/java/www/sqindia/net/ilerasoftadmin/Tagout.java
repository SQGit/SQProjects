 ...
 */
public class Tagout extends AppCompatActivity implements MessageDialogFragment.MessageDialogListener,
    ...
    //*****************************************************************************************************************************
    public static String URL_REGISTER = "http://sqindia01.cloudapp.net/cologix/api/v1/booking/tagOut";
    ...
    public void handleResult(final Result rawResult) {
        ...
        new SweetAlertDialog(this)
                ...
                .setContentText("QR code sucessfully Tagged Out.. \t\t" + rawResult.getContents() + "")
                .setConfirmText("Ok")
                    ...
                    public void onClick(SweetAlertDialog sweetAlertDialog) {
                        ...
                        if (!tagInTime.isEmpty() && !deviceId.isEmpty()) {
                            SharedPreferences sharedPreferences = PreferenceManager
                                    .getDefaultSharedPreferences(Tagout.this);
                            ...
                            new SweetAlertDialog(Tagout.this, SweetAlertDialog.WARNING_TYPE)
                                    .setTitleText("Please Tag Out")
                        ...
                        //   device_id=rawResult.getContents().toString();
    ...
    class MyActivityAsync extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new SweetAlertDialog(Tagout.this, SweetAlertDialog.PROGRESS_TYPE);
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                jsonObject.accumulate("deviceId", "ASDSR##");
                jsonObject.accumulate("tagOutTime", "2015-12-29 04:20:00");
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (status.equals("SUCCESS")) {
                    ...
                    new SweetAlertDialog(Tagout.this, SweetAlertDialog.SUCCESS_TYPE)
                            .setTitleText("QR CODE SCAN!")
                            .setContentText("QR code sucessfully tagged out..")
                            .setConfirmText("OK")
                    ...
                    pDialog.dismiss();
                    new SweetAlertDialog(Tagout.this, SweetAlertDialog.ERROR_TYPE)
                            .setTitleText("Device Mismatched..")
                            .setContentText("")
                            .setConfirmText("OK")

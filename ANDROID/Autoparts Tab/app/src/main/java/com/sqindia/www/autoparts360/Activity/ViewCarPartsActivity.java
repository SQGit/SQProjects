...
import com.sqindia.www.autoparts360.Adapter.ViewPartsAdapter;
...
public class ViewCarPartsActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userid_str = sharedPreferences.getString("user_id", "");
        Log.e("tag","emeka---------->"+userid_str);
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (status.equals("true")) {
                    ...
                    {
                        Log.e("tag","1"+jsonArray.length());
                        photoItem = new PhotoItem();
                        JSONObject jsonObject =jsonArray.getJSONObject(l);
                        photoItem.car_id=jsonObject.getString("car_id");
                        photoItem.car_make=jsonObject.getString("car_make");
                        ...
                        Log.e("tag","gggg--->"+jsonObject.getString("car_image1"));

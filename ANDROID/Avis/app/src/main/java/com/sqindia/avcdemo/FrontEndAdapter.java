 ...
 * @author anfer
 */
public class FrontEndAdapter extends BaseAdapter implements AdapterView.OnItemSelectedListener {
    ...
    public FrontEndAdapter(Activity activity, ArrayList<Model> productList) {
        super();
    ...
    public void onNothingSelected(AdapterView<?> adapterView) {
        MainActivity.seven_btn.setBackground(activity.getResources().getDrawable(R.drawable.circle_shape));
        ...
        if (convertView == null) {
            ...
            holder.mDamage.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int pos, long id) {
                    ...
                    MainActivity.frontEndAdapterStatusMap.put(position,itemStatus);


                    if (itemStatus.equals("Damage")) {
                        String s = productList.get(position).getProduct();
                        String color_code="#004D40";
                        MainActivity.firstundr.add(s+"#colorseven");
                        MainActivity.colorcode.add("seven");
                        ...
                        MainActivity.seven_btn.setBackground(activity.getResources().getDrawable(R.drawable.circle_shape_fe));
                    ...
                    else if(itemStatus.equals("Ok"))
                    {
                        ...
                        MainActivity.firstundr.remove(find_txt+"#colorseven");
            ...
            if (status.equals("true")){
                ...
                MainActivity.frontEndAdapterStatusMap.put(position,"Ok");

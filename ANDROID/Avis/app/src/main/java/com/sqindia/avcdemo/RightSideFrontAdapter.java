 ...
 * @author anfer
 */
public class RightSideFrontAdapter extends BaseAdapter implements AdapterView.OnItemSelectedListener {
    ...
    public RightSideFrontAdapter(Activity activity, ArrayList<Model> productList) {
        super();
        ...
        if (convertView == null) {
            ...
            holder.mDamage.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int pos, long id) {
                    ...
                    MainActivity.rightSideFrontAdapterStatusMap.put(position,itemStatus);
                    if (itemStatus.equals("Damage")) {
                        ...
                        if(treadSize.equals("normal"))
                        {
                            ...
                            MainActivity.firstundr.add(s+"#colorsix");
                            MainActivity.colorcode.add("six");
                            ...
                            MainActivity.six_btn.setBackground(activity.getResources().getDrawable(R.drawable.circle_shape_rf));
                        }
                        else
                        {
                            MainActivity.right_side_treadsize.setText("6");
                            MainActivity.right_side_treadsize.setBackgroundColor(Color.TRANSPARENT);
                            String s = productList.get(position).getProduct();
                            MainActivity.firstundr.add(s+"#colorsix");
                            MainActivity.colorcode.add("six");
                            ((View)(((View)view.getParent()).getParent())).findViewById(R.id.spinner_broken).setEnabled(true);
                           ...
                           /* if (MainActivity.right_side_treadsize.getText().toString().length() > 0) {
                                String s = productList.get(position).getProduct();
                                MainActivity.firstundr.add(s+"#colorsix");
                                MainActivity.colorcode.add("six");
                                ((View)(((View)view.getParent()).getParent())).findViewById(R.id.spinner_broken).setEnabled(true);
                            ...
                            {
                                MainActivity.right_side_treadsize.requestFocus();
                                Toast.makeText(activity,"Please Insert Tread Size for Right Side Front",Toast.LENGTH_LONG).show();
                                MainActivity.right_side_treadsize.setBackgroundColor(Color.parseColor("#f9fcd0"));
                            }*/
                        }
                    }
                    ...
                    {
                        MainActivity.right_side_treadsize.setText("");
                        MainActivity.right_side_treadsize.setBackgroundColor(Color.parseColor("#ffffff"));
                        ...
                        MainActivity.firstundr.remove(find_txt+"#colorsix");
                        ...
                        if (activate_btn > 0)
                        {
                            activate_btn--;
                            if (activate_btn == 0) {
                                MainActivity.six_btn.setBackground(activity.getResources().getDrawable(R.drawable.circle_shape));
                            } else {
                                MainActivity.six_btn.setBackground(activity.getResources().getDrawable(R.drawable.circle_shape_rf));
                            }
                        } else {
            ...
            if (status.equals("true")){
                ...
                MainActivity.rightSideFrontAdapterStatusMap.put(position,"");
                ...
                MainActivity.rightSideFrontAdapterStatusMap.put(position,"Ok");

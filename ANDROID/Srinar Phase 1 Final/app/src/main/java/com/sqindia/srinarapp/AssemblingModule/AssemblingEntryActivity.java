...
public class AssemblingEntryActivity extends Activity{
    ...
    Typeface segoeui;
    String shift,m_part,emp_id,str_sued,str_shift,str_machine,str_operator,str_part,str_subpart,session_token,str_ass_qty,str_remarks,str_dept,str_name,str_role,str_entrydate;

    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapter_machine = new ArrayAdapter<String>
                ...
                str_part = arg0.getItemAtPosition(arg2).toString();
                        ...
                        Log.e("tag","ghghghghghghg----------->"+selected_part);
    ...
    public class viewMachineJobAsync extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                JSONObject jsonObject = new JSONObject();
                json = jsonObject.toString();
                return jsonStr = HttpUtils.makeRequestToken(Config.WEB_URL_GET_ASSEMBLING_WORK, session_token);
            ...
            try {
                ...
                if (status.equals("true")) {
                    ...
                    for(int l=0;l<jsonArray.length();l++)
                    {
                        ...
                        assemblingJobList.ass_productiondate=jsonObject.getString("production_date");
                        assemblingJobList.ass_dispatched=jsonObject.getString("dispatched_qty");
                        assemblingJobList.ass_dis_pending=jsonObject.getString("pendingdispatchqty");
                    ...
                    assembleQcAdapter.notifyDataSetChanged();

...
public class DialogSignatureElectroplate extends Dialog {
    ...
    Typeface segoeuil;
    String set_batchid, str_qty, token, set_qty,str_pincode,set_empid,set_approved;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        set_batchid = sharedPreferences.getString("dia_ele_batch_id", "");
        set_qty =sharedPreferences.getString("dia_ele_pending_qty_ele","");
        set_empid=sharedPreferences.getString("emp_id","");
        set_approved=sharedPreferences.getString("dia_ele_approved","");
            ...
            public void onClick(View v) {
                ...
                if (Util.Operations.isOnline(getContext())) {
                    if (!str_qty.equals("")) {
                        ...
                        int complete_val = Integer.parseInt(set_qty);

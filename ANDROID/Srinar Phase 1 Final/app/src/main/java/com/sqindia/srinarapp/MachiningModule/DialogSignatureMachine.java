...
public class DialogSignatureMachine extends Dialog {
    ...
    Typeface segoeuil;
    String set_batchid, str_qty, token, set_qty,str_pincode,set_empid,initial_qty,set_approved;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        set_qty=sharedPreferences.getString("qc_batchid","");
        set_batchid = sharedPreferences.getString("dia_mac_batch_id", "");
        initial_qty=sharedPreferences.getString("dia_mac_pending_qty_mac","");
        set_approved=sharedPreferences.getString("dia_mac_approved","");
        Log.e("tag","FAN--"+set_approved);
            ...
            public void onClick(View v) {
                ...
                if (Util.Operations.isOnline(getContext())) {
                    if (!str_qty.equals("")) {
                        ...
                        int complete_val = Integer.parseInt(initial_qty);
                        int approve_val= Integer.parseInt(set_approved);
    ...
    public class machineQuantityApprovalAsync extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                jsonObject.accumulate("batchid",set_batchid);

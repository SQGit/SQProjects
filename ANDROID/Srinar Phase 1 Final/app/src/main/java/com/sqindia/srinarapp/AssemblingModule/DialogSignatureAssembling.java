...
public class DialogSignatureAssembling extends Dialog {
    ...
    Typeface segoeuil;
    String set_batchid, str_qty, token, set_qty,str_pincode,set_empid,get_approved;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        set_batchid = sharedPreferences.getString("dialog_batch_id", "");
        set_qty =sharedPreferences.getString("dialog_pending_qty_ass","");
        set_empid=sharedPreferences.getString("emp_id","");
        get_approved=sharedPreferences.getString("dialog_approved","");

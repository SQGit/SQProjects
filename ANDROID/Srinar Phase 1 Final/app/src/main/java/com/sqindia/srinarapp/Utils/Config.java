...
public class Config {
    ...
    public static String Openpath="http://104.197.80.225:4030/admin/";
    public static String localpath="http://192.168.1.2:4030/admin/";
    ...
    public static final String WEB_URL_GET_PARTS=currentPath+"getsimplesubpartbymainpart";
    ...
    public static final String WEB_URL_GET_QC_LIST = currentPath+"getqclogsbybatchid";
    ...
    public static final String WEB_URL_GET_MACHINE_ENTRIES = currentPath+"getallmachineentries";
    public static final String WEB_URL_MACHINE_APPROVAL = currentPath+"machineqtyapproval";
    ...
    public static final String WEB_URL_GET_ELECTROPLATE_WORK = currentPath+"getallelectroplatingentries";
    public static final String WEB_URL_ELECTROPLATE_APPROVAL = currentPath+"electroplatingqtyapproval";
    ...
    public static final String WEB_URL_GET_ASSEMBLING_WORK = currentPath+"getallassemblingentries";
    public static final String WEB_URL_ASSEMBLING_APPROVAL = currentPath+"assemblingapproval";
